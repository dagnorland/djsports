...
class DJPlaylistAdapter extends TypeAdapter<DJPlaylist> {
  ...
  DJPlaylist read(BinaryReader reader) {
    ...
    return DJPlaylist(
      ...
      appleMusicPlaylistId: fields[10] == null ? '' : fields[10] as String,
    );
  }
  ...
  void write(BinaryWriter writer, DJPlaylist obj) {
    writer
      ...
      ..write(obj.position)
      ..writeByte(10)
      ..write(obj.appleMusicPlaylistId);
  }
...
DJPlaylist _$DJPlaylistFromJson(Map<String, dynamic> json) => DJPlaylist(
  ...
  appleMusicPlaylistId: json['appleMusicPlaylistId'] as String? ?? '',
);
...
Map<String, dynamic> _$DJPlaylistToJson(DJPlaylist instance) =>
    <String, dynamic>{
      ...
      'appleMusicPlaylistId': instance.appleMusicPlaylistId,
    };
